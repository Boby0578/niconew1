...
const appartenir: Verb = {
  name: "appartenir",
  conjugations: {
    "indicatif présent": { "je": "appartiens", "tu": "appartiens", "il/elle": "appartient", "nous": "appartenons", "vous": "appartenez", "ils/elles": "appartiennent" },
    "indicatif imparfait": { "je": "appartenais", "tu": "appartenais", "il/elle": "appartenait", "nous": "appartenions", "vous": "apparteniez", "ils/elles": "appartenaient" },
    "indicatif passé simple": { "je": "appartins", "tu": "appartins", "il/elle": "appartint", "nous": "appartînmes", "vous": "appartîntes", "ils/elles": "appartinrent" },
    "indicatif futur simple": { "je": "appartiendrai", "tu": "appartiendras", "il/elle": "appartiendra", "nous": "appartiendrons", "vous": "appartiendrez", "ils/elles": "appartiendront" },
    "indicatif passé composé": { "je": "ai appartenu", "tu": "as appartenu", "il/elle": "a appartenu", "nous": "avons appartenu", "vous": "avez appartenu", "ils/elles": "ont appartenu" },
    "indicatif plus-que-parfait": { "je": "avais appartenu", "tu": "avais appartenu", "il/elle": "avait appartenu", "nous": "avions appartenu", "vous": "aviez appartenu", "ils/elles": "avaient appartenu" },
    "indicatif passé antérieur": { "je": "eus appartenu", "tu": "eus appartenu", "il/elle": "eut appartenu", "nous": "eûmes appartenu", "vous": "eûtes appartenu", "ils/elles": "eurent appartenu" },
    "indicatif futur antérieur": { "je": "aurai appartenu", "tu": "auras appartenu", "il/elle": "aura appartenu", "nous": "aurons appartenu", "vous": "aurez appartenu", "ils/elles": "auront appartenu" },
...
const obtenir: Verb = {
  name: "obtenir",
  conjugations: {
    "indicatif présent": { "je": "obtiens", "tu": "obtiens", "il/elle": "obtient", "nous": "obtenons", "vous": "obtenez", "ils/elles": "obtiennent" },
    "indicatif imparfait": { "je": "obtenais", "tu": "obtenais", "il/elle": "obtenait", "nous": "obtenions", "vous": "obteniez", "ils/elles": "obtenaient" },
    "indicatif passé simple": { "je": "obtins", "tu": "obtins", "il/elle": "obtint", "nous": "obtînmes", "vous": "obtîntes", "ils/elles": "obtinrent" },
    "indicatif futur simple": { "je": "obtiendrai", "tu": "obtiendras", "il/elle": "obtiendra", "nous": "obtiendrons", "vous": "obtiendrez", "ils/elles": "obtiendront" },
    "indicatif passé composé": { "je": "ai obtenu", "tu": "as obtenu", "il/elle": "a obtenu", "nous": "avons obtenu", "vous": "avez obtenu", "ils/elles": "ont obtenu" },
    "indicatif plus-que-parfait": { "je": "avais obtenu", "tu": "avais obtenu", "il/elle": "avait obtenu", "nous": "avions obtenu", "vous": "aviez obtenu", "ils/elles": "avaient obtenu" },
    "indicatif passé antérieur": { "je": "eus obtenu", "tu": "eus obtenu", "il/elle": "eut obtenu", "nous": "eûmes obtenu", "vous": "eûtes obtenu", "ils/elles": "eurent obtenu" },
    "indicatif futur antérieur": { "je": "aurai obtenu", "tu": "auras obtenu", "il/elle": "aura obtenu", "nous": "aurons obtenu", "vous": "aurez obtenu", "ils/elles": "auront obtenu" },
    ...
    "conditionnel présent": { "je": "obtiendrais", "tu": "obtiendrais", "il/elle": "obtiendrait", "nous": "obtiendrions", "vous": "obtiendriez", "ils/elles": "obtiendraient" },
    "conditionnel passé première forme": { "je": "aurais obtenu", "tu": "aurais obtenu", "il/elle": "aurait obtenu", "nous": "aurions obtenu", "vous": "auriez obtenu", "ils/elles": "auraient obtenu" },
    "conditionnel passé deuxième forme": { "je": "eusse obtenu", "tu": "eusses obtenu", "il/elle": "eût obtenu", "nous": "eussions obtenu", "vous": "eussiez obtenu", "ils/elles": "eussent obtenu" },
...
const intervenir: Verb = {
  name: "intervenir",
  conjugations: {
    "indicatif présent": { "je": "interviens", "tu": "interviens", "il/elle": "intervient", "nous": "intervenons", "vous": "intervenez", "ils/elles": "interviennent" },
    "indicatif imparfait": { "je": "intervenais", "tu": "intervenais", "il/elle": "intervenait", "nous": "intervenions", "vous": "interveniez", "ils/elles": "intervenaient" },
    "indicatif passé simple": { "je": "intervins", "tu": "intervins", "il/elle": "intervint", "nous": "intervînmes", "vous": "intervîntes", "ils/elles": "intervinrent" },
    "indicatif futur simple": { "je": "interviendrai", "tu": "interviendras", "il/elle": "interviendra", "nous": "interviendrons", "vous": "interviendrez", "ils/elles": "interviendront" },
    ...
    "conditionnel présent": { "je": "interviendrais", "tu": "interviendrais", "il/elle": "interviendrait", "nous": "interviendrions", "vous": "interviendriez", "ils/elles": "interviendraient" },
